...
const Login = () => {
    return (
        <div className="w-full h-full relative font-sserif">
            <div className="fixed flex flex-col justify-center border border-[#C1C1C1] w-1/3 h-2/3 top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 bg-[#F4F4F4] shadow-xl rounded-xl py-8">
                <form action="">
