...
const Footer = () => {
    return (
        <div className="font-sserif grid grid-cols-[fr_1fr_1fr_1fr] grid-rows-[3fr_1fr] pt-8">
            <div className="flex col-start-1 col-span-1 px-16 pl-48">
            ...
            <div className="flex col-start-2 col-span-3 justify-end gap-32 pr-48">
            ...
            <div className="flex items-center col-start-1 col-span-4 justify-end pr-48 bg-[#FF903D] px-16">
