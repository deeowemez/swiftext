            ...
            <div className="w-4/5 max-w-screen-xl py-20 bg-[#FFF9F5] rounded-[50px]">
                ...
                <div className="flex flex-col sm:flex-col md:flex-col lg:flex-col xl:flex-row items-center justify-end xl:h-[750px]">
                    ...
                    <div className="relative w-4/5 lg:w-full xl:w-2/3 order-1 xl:order-2" >
                        <img src={ftBlob2} alt="Features Blob Design" className="my-12 md:-20 lg:m-20 xl:m-24 w-full lg:w-5/6 xl:w-5/6 max-w-[800px]" />
                        <img src={customGif} alt="" className="absolute top-[110px] left-12 md:top-[140px] md:left-[80px] lg:top-48 lg:left-[150px] xl:top-52 xl:left-[180px] w-4/5 lg:w-2/3 xl:w-2/3 max-w-[650px] rounded-[180px] " />
                    </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-col md:flex-col lg:flex-col xl:flex-row items-center justify-start xl:h-[750px]">
                    <div className="relative w-4/5 lg:w-full xl:w-2/3">
                        <img src={ftBlob3} alt="Features Blob Design" className="my-12 md:-20 lg:m-20 xl:m-24 w-full lg:w-5/6 xl:w-5/6 max-w-[800px] " />
                        <img src={realTimeGif} alt="" className="absolute top-36 left-12 md:top-48 md:left-[90px] lg:top-64 lg:left-[210px] xl:top-64 xl:left-[196px] w-3/5 lg:w-1/2 xl:w-1/2 max-w-[500px] rounded-[180px]" />
                    </div>
                ...
                <div className="flex flex-col sm:flex-col md:flex-col lg:flex-col xl:flex-row items-center justify-end xl:h-[750px]">
                    ...
                    <div className="relative w-4/5 lg:w-full xl:w-2/3 order-1 xl:order-2">
                        <img src={ftBlob4} alt="Features Blob Design" className="my-12 md:-20 lg:m-20 xl:m-24 w-full lg:w-5/6 xl:w-5/6 max-w-[800px]" />
                        <img src={downloadGif} alt="" className="absolute top-[150px] left-[40px] md:top-[200px] md:left-[50px] lg:top-[280px] lg:left-[160px] xl:top-[280px] xl:left-[150px] w-4/5 lg:w-2/3 xl:w-8/12 max-w-[600px] rounded-[80px] xl:rounded-[90px] " />
                    </div>
                </div>
