...
const Header = ({ user, setUser, onLoginClick, onSignUpClick }) => {
  ...
  return (
    <header className="font-sserif text-sm text-[#5A5959] w-screen flex justify-between items-center py-1.5 px-36">
      <a href="/" className="flex">
        ...
        <div className="font-title text-3xl gradient-text font-bold py-2 px-1 cursor-pointer">
          Swiftext
        </div>
      </a>
      <nav>
        <ul className="flex gap-x-10 cursor-pointer">
          <li>
            <a href="/" className="text-[#5A5959]">
              Home
            </a>
          </li>
          {/* <li><a href="/edit" className="text-[#5A5959]">Edit</a></li> */}
          <li>
            <a href="/files" className="text-[#5A5959]">
              Files
            </a>
          </li>
        </ul>
        ...
        {user?.email ? (
          <>
            ...
            <div
              ...
              className="p-2 rounded-md cursor-pointer flex gap-2.5 items-center hover:text-red-500"
            >
              Log out
