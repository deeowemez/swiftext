    ...
    return (
        <div className="w-screen flex flex-col items-center font-sserif p-16 relative">
            ...
            <div className="z-10 flex justify-center border-[#F4F4F4] mt-20 p-3 rounded-[1rem]">
                <img src={tutorialGif} alt="Tutorial GIF" className="w-11/12 z-10 rounded-[0.5rem] border-1 border-[#F4F4F4] shadow-xl" />
            </div>
            <img src={hlBlob1} alt="blob design 1" className="absolute top-0 left-0 z-0" />
            <img src={hlBlob2} alt="blob design 2" className="absolute bottom-0 right-0 z-0" />
        </div>
    )
}
