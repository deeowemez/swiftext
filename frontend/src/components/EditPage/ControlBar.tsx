...
const ControlBar = ({
  ...
  const handleRemoveProfile = (index: number) => {
    setLocalProfile((prevProfile) => prevProfile.filter((_, i) => i !== index));
  };
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await axios.post(
        `${backendUrl}/api/profile/save?userID=${currentUser?.userID}`,
        { items: localProfile },
      );
      ...
      if (response.data.success) {
        ...
        const changedColors: Record<string, string> = Object.keys(
          currentColorMap,
        ).reduce(
          (acc, key) => {
        ...
        <>
          ...
          >
            <form
              ...
              className="grid md:grid-rows-[88%_12%] lg:grid-rows-[90%_10%] w-full h-full"
            >
              {/* Render all dynamically added fields */}
              <div className="row-start-1 flex flex-wrap content-start items-start justify-center xl:justify-start gap-3 overflow-x-auto border border-[#d4d4d4] rounded-lg p-5">
                {localProfile.map((profile, index) => (
                  <div
                    key={profile.configID.S}
                    className="w-full max-w-[390px] h-[140px] border border-gray-300 rounded-md p-4 shadow-sm flex bg-[#EEEEEE] overflow-hidden"
                  >
                    {/* Highlight Color */}
                      ...
                      <div className="flex justify-between mb-4">
                        ...
                        <div className="flex gap-1.5 items-center">
                          <IcontipButton
                            ...
                            iconSize="w-3.5"
                            altText="text-bg-color-icon"
                            tooltipText="Text Background Color"
                            direction="left"
                          />
                          <div className="rounded-sm bg-[#E1E1E1] flex items-center justify-center px-2 gap-1">
                            <div
                            ...
                            <label className="text-center text-sm">
                              {profile.background.S === ""
                                ? "None"
                                : profile.background.S.toUpperCase()}
                            </label>
                          </div>
                        </div>
                      ...
                      <div className="flex pl-5 justify-between">
                        ...
                        <div
                          ...
                          onClick={(e) =>
                            handleProfileChange(
                              index,
                              "italic",
                              !localProfile[index].italic.BOOL,
                            )
                          }
                        >
                          <IcontipButton
                        ...
                        <div
                          ...
                          onClick={(e) =>
                            handleProfileChange(
                              index,
                              "underline",
                              !localProfile[index].underline.BOOL,
                            )
                          }
                        >
                          <IcontipButton
                        ...
                        <div
                          ...
                          onClick={(e) =>
                            handleProfileChange(
                              index,
                              "strike",
                              !localProfile[index].strike.BOOL,
                            )
                          }
                        >
                          <IcontipButton
                        ...
                        <div
                          ...
                          onClick={() =>
                            handleProfileChange(
                              index,
                              "list",
                              localProfile[index].list.S === "bullet"
                                ? ""
                                : "bullet",
                            )
                          }
                        >
                          <IcontipButton
                            ...
                            iconSize="w-3"
                            altText="unordered-list-icon"
                            tooltipText="Unordered List (Bullets)"
                            direction="top"
                          />
                        </div>
                        ...
                        <div
                          ...
                          onClick={() =>
                            handleProfileChange(
                              index,
                              "list",
                              localProfile[index].list.S === "ordered"
                                ? ""
                                : "ordered",
                            )
                          }
                        >
                          <IcontipButton
                            ...
                            iconSize="w-3"
                            altText="ordered-list-icon"
                            tooltipText="Ordered List (Numbers)"
                            direction="top"
                          />
                        </div>
                      </div>
