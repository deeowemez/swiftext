...
const HighlightArrangementOverlay: React.FC<
  HighlightArrangementOverlayProps
> = ({ highlights, setHighlights, setShowArrangementOverlay }) => {
        ...
        <DragDropContext onDragEnd={onDragEnd}>
          <Droppable droppableId="highlights-list">
            {(provided) => (
              ...
              >
                <p className="px-2 pb-3 text-[13px] text-gray-400">
                  Drag to rearrange highlights
                </p>
